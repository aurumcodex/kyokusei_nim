...
proc displayText*(id: uint) =
  ...
  case id:
    of 0..10:
      ...
      # tteSetColor()
      tteInitChr4c(1, BG_CBB(4) or BG_SBB(10), 0xF000, bytes2word(1,2,0,0), CLR_LIME, addr verdana9Font, nil)
    ...
    of 11..20:
      tteInitChr4c(1, BG_CBB(4) or BG_SBB(10), 0xF000, bytes2word(1,2,0,0), CLR_BLUE, addr verdana9Font, nil)
      tteWrite("#{P:0, 20} Printing from case 2 of displayText()")
    of 42:
      tteInitChr4c(1, BG_CBB(4) or BG_SBB(10), 0xF000, bytes2word(1,2,0,0), CLR_MEDGRAY, addr verdana9Font, nil)
      tteSetMargins(16, 10, 224, 40)
