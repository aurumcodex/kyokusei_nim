...
<div align="center">
    ...
    <table>
        ...
        <tr>
            ...
            <td><img src="https://img.shields.io/badge/license-Apache 2.0-137.svg?style=flat-square" alt="License Used"/></td>
...
== License
This project is (currently) licensed under the link:LICENSE[MIT License].
